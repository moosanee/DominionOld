...
public class TrashPileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trashPileList = (ArrayList<CardMultiTag>) getIntent().getSerializableExtra("trashPileListKey");
        ...
        if (trashPileList.size() == 0){
           ...
           String drawableString = "";
            for (int i = 0; i < trashPileList.size(); i++){
                CardMultiTag cmt = trashPileList.get(i);
